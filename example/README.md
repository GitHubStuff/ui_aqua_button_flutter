...
- Find/Replace `aqua_demo` to name of the flutter name of the app (ex: `my_spiffy_app`)
- Find/Replace `Aqua Demo` to a label used to name the app on mobile Platforms (ex:`My Spiffy Mobile App`)
- Find/Replace `Mac Aqua Demo` to the name of your macOS app (ex: `My Spiffy macOS App`)
...
- Find/Replace `aqua_demo` with bundle id (ex: `my_spiffy_app`) **[using the folder name is ideal]**
- Find/Replace `uiAquaButton` for Apple bundles as iOS/MacOS do like '_'. **[ideal is folder name to lower-camel case (ex: `mySpiffyApp`)]**
